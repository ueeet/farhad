  ...
  return (
    ...
    >
      ...
      >
        <span
          ref={farhadRef}
          className="hero-title-farhad block font-display font-black leading-[0.82] tracking-[-0.05em] text-text text-[clamp(3.6rem,13.5vw,15.3rem)] text-left pl-[0.5%]"
      ...
      >
        <span
          ref={ivanovRef}
          className="hero-title-ivanov block font-display font-black italic leading-[0.82] tracking-[-0.05em] text-text text-[clamp(3.6rem,13.5vw,15.3rem)] text-right pr-[0.5%]"
          style={{ transform: "translateX(120%)" }}
        >
          ИВАНОВ
        </span>
